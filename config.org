...
** Folding
The [[https://github.com/jamescherti/kirigami.el][kirigami]] Emacs package offers a unified interface for opening and closing folds across a diverse set of major and minor modes in Emacs.
#+begin_src emacs-lisp
...
[[https://github.com/emacs-tree-sitter/treesit-fold#-installation][treesit-fold]] builds on top of ~treesit.el~ to provide code folding based on the tree-sitter syntax tree.
#+begin_src emacs-lisp
...
Integrate workspace buffers with ~consult-buffer~.
#+begin_src emacs-lisp
